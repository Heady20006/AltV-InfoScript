...
import * as Props from "./includes/props";
import * as Vehicles from "./includes/vehicles";
import * as Textures from "./includes/textures";
import * as Peds from "./includes/peds";
import Raycast from "./includes/raycast";
let PropList = Props.props;
let VehicleList = Vehicles.vehicles;
let TextureList = Textures.textures;
let PedList = Peds.peds;
let InfoBoxes = [];
                ...
                vSpeed.Color =
                    vHealth.Color =
                        vPetrolHealth.Color =
                            { r: 200, g: 200, b: 200, a: 255 };
// Raycast-Information
let RaycastModeInfo = new InfoBox("Raycast-Mode", { r: 0, g: 255, b: 0, a: 200 }, Alignement.Center);
...
alt.everyTick(() => {
    ...
    RaycastModeInfo.Title = `Raycast-Mode: ${modeTitle} (Flag: ${choosenFlag})`;
